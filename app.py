...
def parse_input_with_gpt(user_text: str, langfuse_client) -> dict:
    ...
    system_prompt = (
        ...
        "2) Oblicz średni czas w sekundach na 1 kilometr, a następnie przemnóż go przez 21.0975, aby otrzymać Czas_sec.\n"
        "3) Jeśli nie da się wyodrębnić czasu lub dystansu, ustaw Czas_sec = 0.\n"
        "4) Dodatkowe dane: Wiek (domyślnie 0), Płeć (M lub K, domyślnie M), Imię/Nazwisko/Miasto/Drużyna (z wartościami domyślnymi).\n"
